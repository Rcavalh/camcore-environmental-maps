#!/usr/bin/env bash
#BSUB -J frost5_bench_1024x6
#BSUB -q cnr
#BSUB -n 6
#BSUB -W 02:00
#BSUB -R "span[hosts=1]"
#BSUB -R "rusage[mem=16GB]"
#BSUB -o 8.Dados_Meteorologicos_Publicos/08_Five_State_Environmental_Integration/hpc_full_native_rf/logs/lsf_bench_1024x6.%J.out
#BSUB -e 8.Dados_Meteorologicos_Publicos/08_Five_State_Environmental_Integration/hpc_full_native_rf/logs/lsf_bench_1024x6.%J.err
set -euo pipefail
source 8.Dados_Meteorologicos_Publicos/08_Five_State_Environmental_Integration/hpc_full_native_rf/hpc/runtime_env.sh
export FROST_OUTPUT="$FROST_MODULE/outputs/hpc_optimization_benchmark/tile1024_cpu6"
...
echo "HPC_OPTIMIZATION_BENCHMARK_OK=tile1024_cpu6"
