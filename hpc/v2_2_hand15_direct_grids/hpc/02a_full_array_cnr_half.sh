#!/usr/bin/env bash
#BSUB -J "frostv22_cnr[1-48]%20"
#BSUB -q cnr
#BSUB -n 3
#BSUB -W 24:00
#BSUB -R "span[hosts=1] rusage[mem=8GB]"
#BSUB -o 8.Dados_Meteorologicos_Publicos/08_Five_State_Environmental_Integration/hpc_article_v2_2_direct_grids_hand15_2000_2026/logs/lsf_full_cnr.%J.%I.out
#BSUB -e 8.Dados_Meteorologicos_Publicos/08_Five_State_Environmental_Integration/hpc_article_v2_2_direct_grids_hand15_2000_2026/logs/lsf_full_cnr.%J.%I.err
set -euo pipefail
...
echo "ARTICLE_V2_2_HAND15_CNR_SHARD_OK=$index"
