...
const layerText={
  en:{frost_probability:['Frost-occurrence probability','Version 2.0 complete-period climatology · 2000–2026','Complete five-state analytical surface'],expected_frost_days:['Expected frost days per season','Version 2.0 complete-period climatology · 2000–2026','Complete five-state analytical surface'],seasonal_tmin:['Seasonal minimum temperature','Version 2.0 complete-period climatology · 2000–2026','Complete five-state analytical surface'],hand:['Drainage-relative elevation (HAND) — 2 km','HAND derived from ANADEM · 2-km flow-path limit','Derived terrain layer'],anadem:['Terrain elevation','ANADEM v1 digital terrain model · native ~30 m','Third-party source layer; cite Laipelt et al. (2024)']},
  pt:{frost_probability:['Probabilidade de ocorrência de geada','Climatologia v2.0 do período completo · 2000–2026','Superfície analítica completa para os cinco estados'],expected_frost_days:['Dias esperados de geada por temporada','Climatologia v2.0 do período completo · 2000–2026','Superfície analítica completa para os cinco estados'],seasonal_tmin:['Temperatura mínima sazonal','Climatologia v2.0 do período completo · 2000–2026','Superfície analítica completa para os cinco estados'],hand:['Elevação relativa à drenagem (HAND) — 2 km','HAND derivado do ANADEM · limite de fluxo de 2 km','Camada derivada do terreno'],anadem:['Elevação do terreno','Modelo digital de terreno ANADEM v1 · ~30 m nativos','Camada de terceiros; cite Laipelt et al. (2024)']}
};
